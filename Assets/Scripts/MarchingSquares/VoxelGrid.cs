...
public class VoxelGrid : MonoBehaviour
{
    ...
    private void SetVoxelColors()
    {
        ...
        {
            voxels[i].gameObject.GetComponent<Renderer>().sharedMaterial = voxels[i].state ? activeMat : deactiveMat;
        }
    }
